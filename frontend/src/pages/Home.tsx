        ...
        <div style={{ borderTop: "1px solid #F3F4F6" }}>
          ...
          >
            ...
            <svg
              ...
              strokeWidth="2.5"
              style={{
                transform: prosiren ? "rotate(180deg)" : "rotate(0deg)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          d="M0 520 Q100 500 200 515 Q300 530 400 510 L400 600 L0 600 Z"
          fill="#0F2744"
          opacity="0.9"
        />
      </svg>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              <span style={{ fontSize: 13, fontWeight: 700, color: "#1D4ED8" }}>
                {objekti[0].cijenaOd === 0
                  ? "Besplatno"
                  : `${objekti[0].cijenaOd}€/h`}
              </span>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: "none",
                    background: aktivan ? "#1D4ED8" : "transparent",
                    color: aktivan ? "#fff" : "#374151",
