          ...
          <div style={{ background: "#fff", borderRadius: 20, padding: 28, boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <button style={{ padding: "10px 20px", borderRadius: 10, background: "#fff", color: "#1D4ED8", fontWeight: 600, fontSize: 14, border: "1.5px solid #1D4ED8", cursor: "pointer" }}>+ Dodaj objekt</button>
                <button style={{ padding: "10px 20px", borderRadius: 10, background: "linear-gradient(135deg, #1D4ED8 0%, #3B82F6 100%)", color: "#fff", fontWeight: 600, fontSize: 14, border: "none", cursor: "pointer" }}>✏️ Uredi</button>
              </div>
            </div>
            {ucitavanjeObjekti ? <p style={{ color: "#6B7280", textAlign: "center", padding: 40 }}>Učitavam...</p> : mojiObjekti.length === 0 ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                {mojiObjekti.map((obj) => (
                  <div key={obj.ID_objekta} style={{ padding: 20, borderRadius: 16, border: "1px solid #E5E7EB" }}>
                    <Link to={`/objekt/${obj.ID_objekta}`} style={{ textDecoration: "none" }}>
